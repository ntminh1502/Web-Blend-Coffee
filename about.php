...
<?php 
   ...
   ?>
  <head>
    <title>Coffee - Về chúng tôi</title>
    <meta charset="utf-8">
	      ...
	      <div class="row d-flex no-gutters">
	      	<?php
		        ...
		        <div class="col-lg align-self-sm-end">
		          <div class="testimony">
		             <blockquote>
		                <p>&ldquo;<?php echo $row["phan_hoi"];?>.&rdquo;</p>
		              </blockquote>
		              <div class="author d-flex mt-4">
		                <div class="image mr-3 align-self-center">
		                  <img src="images/person_1.jpg" alt="">
		                </div>
		                <div class="name align-self-center"><?php echo $row["ten_khach_hang"];?><span class="position"><?php echo $row["nghe_nghiep"];?></span></div>
		              </div>
		          </div>
		        </div>
		        <?php
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row align-items-center">
	            ...
	            <p><a href="#" class="btn btn-primary btn-outline-primary px-4 py-3">Xem đầy đủ Menu</a></p>
	          </div>
    			</div>
    			<div class="col-md-6">
    				<div class="row">
