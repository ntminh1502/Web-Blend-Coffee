...
if (isset($_POST['phuong_thuc']) && $_POST['phuong_thuc'] == "tm") 
{
    ...
    VALUES ('".$vnp_TxnRef."','".json_encode($_SESSION['cart'])."','thanh toan khi nhan hang','".$vnp_Amount."','".$ten."','".$ho."','".$ten_duong."','".$so_nha."','".$tinh_thanh_pho."','".$quan_huyen."','".$phuong_xa."','".$dien_thoai."','".$email."')";
